            ...
            <div className="relative">
                ...
                <div className="bg-[#0000008a] w-[100vw] h-screen absolute top-0 flex flex-col justify-center ">
                    <div className="text-white mx-[70px]">
                       ...
                       <h1 className="font-bold laptop:text-[80px] mobile:text-[40px] mobile:border-l-0 text-[80px] border-l-[5px]  border-[#ff6000] border-solid px-[20px]">PROFIL</h1>
                    </div>
                </div>    
            </div>
            <div className="laptop:flex laptop:flex-row laptop:mt-[0px] tablet:mt-[500px]  tablet:w-screen mobile:flex mobile:flex-col-reverse mobile:h-screen  w-full h-screen flex  flex-row mobile:mt-[880px]">
                <div className="laptop:w-[50%] mobile:w-[100%] w-[50%]">
                    <div className="my-[40px] mx-[20px]">
                        <h1 className="laptop:text-[30px] mobile:text-[20px] font-bold text-[30px] my-[30px] py-[10px] px-[20px] relative before:absolute before:left-0 before:top-0 before:w-[5px] before:h-full before:bg-[#ff6000]">Sejarah Singkat</h1>
                ...
                <img src={image2} alt="" className="laptop:w-[50%] laptop:px-[0px] laptop:my-[40px] laptop:mx-[40px] tablet:px-[30px] mobile:w-[100%] mobile:mx-[0px] mobile:my-[0px]  w-[50%] my-[40px] mx-[20px]"/>
            </div> 
            <div className="w-full  ">
                <div className="flex justify-center items-center my-[30px]">
                    <h1 className="border-b-4 border-[#ff6000] border-solid font-bold text-[30px]">Visi dan Misi</h1>
                </div>
                <div className=" laptop:flex laptop:flex-row laptop:gap-[0] mobile:flex mobile:flex-col mobile:gap-[20px]  flex flex-row  justify-center my-[20px]">
                    <div className=" laptop:w-[300px] laptop:mx-[30px]  mobile:w-screen mobile:mx-[0px]  w-[300px] bg-[#ff6000] text-white mx-[30px]">
                    ...
                    <div className="laptop:w-[700px] mobile:w-screen w-[700px] bg-[#ff6000] text-white">
